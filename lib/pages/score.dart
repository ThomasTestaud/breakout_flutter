    ...
    return Scaffold(
      ...
      body: Center(
        child: Padding(
          ...
          children: [
            const Text("Fin de la partie !", style: TextStyle(fontSize: 25, color: Color.fromARGB(255, 199, 91, 28))),
            ...
            child: SizedBox.fromSize(
              ...
              child: Image.asset(widget.score > 4 ? 'img/great.gif' : widget.score > 3 ? 'img/good.gif' : 'img/bad.gif', fit: BoxFit.cover),
            ),
          ),
            const SizedBox(height: 20),
            ElevatedButton(
